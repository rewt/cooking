...
**Mix-in**
- Candy-coated chocolate — mini or regular M&M's

> **Note on "organic" M&M's:** Mars does not currently sell a certified-organic M&M's line, so this is the one ingredient where strict organic isn't available off-the-shelf. If you want the whole recipe organic-compliant, swap in **Unreal Candy Coated Chocolate Gems** or **SunSpire/Sjaak's organic coated chocolate drops** — both are widely used as the "organic M&M" substitute and bake the same way. Otherwise, regular mini M&M's work fine and are what most bakery cookies actually use.
